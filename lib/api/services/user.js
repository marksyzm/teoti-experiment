...
_.extend(User.prototype, {
    ...
    update: function (query, user, cb) {
        ...
        self.checkUsernameEmail(query._id, user.username, user.email, function (err) {
            if (err) { return cb(err, null); }
            ...
            Model.prototype.update.call(self, { _id: query._id }, user, function (err, user) {
                if (err) { return cb(err, null); }
                if (sendEmail) {
                    email.activateUser(user, function (err) {
                        if (err) { return cb(err, null); }
